...
\def \ttitle {Using Combinatorial Interaction Testing to Repair Models of Configurable Software Systems} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
While most of the techniques in software testing are applied to debugging, fault-localization, and repair of code, to the best of our knowledge there are fewer works regarding the application of software testing, \red{specifically combinatorial interaction testing,} to locating faults in models and to the automated repair of such faults.
The goal of this PhD thesis is to study how testing can be applied to repair models of \red{configurable} software systems. %of configurable systems. %, using software testing to obtain a set of failing test cases to drive the repair process.
...
The goal of this thesis is to study how software testing techniques \red{, and in particular combinatorial interaction testing (CIT)}, can be applied to drive automatic repair of models of software variability.
...
\red{More specific concepts, such as timed automata, and definitions, are described in the corresponding chapters throughout the thesis.}
