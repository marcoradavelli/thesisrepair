...
\subsection{Benchmarks}\label{sec:benchmarks1}
...
\begin{tikzborder}{\cite{arcaini2019varivolution}}
	...
	\section{Conclusion}\label{sec:conclusions1}
...
\ref{table:benchmarks1} also reports \syntDist and \semConf of each benchmark \initTa.
