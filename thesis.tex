...
Automatically repair the model so that it maintains conformance, by applying small edits to it, is the goal of the approach. Chapter 5 describes an approach to this repair problem using information coming from tests on the real system. The contribution of this thesis is a framework for the development of approaches to repair different types of models. 
