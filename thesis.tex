...
\def \ttitle {Using Model-Based Testing to Repair Models of Configurable Software Systems} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
While most of the techniques in software testing are applied to debugging, fault-localization, and repair of code, to the best of our knowledge there are fewer works regarding the application of software testing to locate faults in models, and to the automated repair of such faults.
The goal of this PhD thesis is to study how testing, \red{and specifically model-box testing,} % and in many cases a technique known as \textit{combinatorial interaction testing},
can be applied to repair models of \red{configurable} software systems. %, i.e., models having some parts that can be mapped to logical constraints, that can then be manipulated in order to repair the semantic meaning of the entire model.} %of configurable systems. %, using software testing to obtain a set of failing test cases to drive the repair process.
...
The goal of this thesis is to study how \red{model-based software testing, and in particular \textit{combinatorial interaction testing} (CIT)}, can be applied to drive automatic repair of models of software variability.
...
\red{Part of the goal of the thesis} is the application of model repair technique directly \red{to \textit{configuration constraints}, i.e., constraints under which} (and only under which) the system is supposed to work correctly, or shows a certain property. 
...
\begin{enumerate}
	...
	The co-authors further contributed in writing the paper, implementing the approach, \red{in writing the code to report data from evaluation, and in further discussions and proof reading.}
...
Furthermore, M. Radavelli contributed to a paper that we here only mention, as \red{it} goes beyond the scope of this thesis. It presents a framework for testing a medical protocol using ASM model refinement (paper C in the list below), and it is the fruit of a collaboration between the FMSE lab at the University of Bergamo \footnote{Formal Methods and Software Engineering Lab at University of Bergamo: \url{https://foselab.unibg.it/}}, and the  team of Prof. Yu Lei at University of Texas at Arlington.
