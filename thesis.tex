...
Chapter \ref{ch:fmrepair} presents a
...
This tool could be used not only to improve the constraint repair method devised (in Chapter \ref{ch:constraintrepair}), but also as an alternative fault localization technique.
...
\begin{enumerate}
	...
	M. Radavelli contributed in the discussion towards this paper, in the tool implementation using Xtext Web \todo{cite}, in the comparison with existing tools, and in writing the paper.
...
The contents of this thesis have also been accepted for presentation, in the form of a poster and/or presentation, to the following two software engineering conferences, in which an extended abstract has been included in the conference proceedings:
...
To make this thesis more self-contained, this chapter presents an overview of the context of model repair, i.e., model-driven software engineering (Sect. \ref{sec:modeldriven}), of the main common techniques used in the approaches proposed in this thesis, i.e., software testing and fault localization, evolutionary algorithms, SAT and SMT solvers, and BDD and MDD representations (Sect. \ref{sec:testing}), and some background over the specific software models targeted in the repair processes, i.e., logical constraints, feature models, and timed automata (Sect. \ref{sec:models}).

\section{Model-Driven Software Engineering}\label{sec:modeldriven}
...
\section{Software Testing}\label{sec:testing}
...
\todo{We use SAT and SMT solvers to determine if a test is satisfiable or not. It is related to the oracle problem. These techniques are also used to identify redundant constraints, and for constraints simplification. They also allow to obtain failure-inducing combinations between two sets of constraints.}
...
An example of time automaton is given in Fig. \ref{fig:time}.\todo{figura}
...
Some methods have been introduced to automate the process of inferring constraints, but they do not aim at \textit{repairing} existing ones \cite{Abukwaik_2016,Temple:2016:UML:2934466.2934472}. 
