...
\researchquestion{What are the main application of software testing?}
...
\researchquestion{What are the main applications and tools for program repair and model repair?}
...
Automatically repair the model in order to maintain conformance, by applying small edits to it, is the goal of the approach. Chapter 5 describes an approach to this repair problem using information coming from tests on the real system. The contribution of this thesis is a framework for the development of approaches to repair different types of models. 
\researchquestion{How to improve the readability and understandability of ASM specifications?}
...
\part{Test-Driven Model Repair Framework}
...
\part{Failure-Driven Model Repair}
